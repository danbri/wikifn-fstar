...
run_fstar() {
  ...
  "$cmd" \
    --codegen OCaml \
    --extract 'Wikifn.Primitive.Kernel Wikifn.Primitives Wikifn.Composition Wikifn.Generated.Compositions Wikifn.Compiled.Compositions Wikifn.Specialized.Compositions' \
    --odir "$out_dir" \
...
echo "$out_dir/Wikifn_Compiled_Compositions.ml"
