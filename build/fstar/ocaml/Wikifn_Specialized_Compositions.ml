...
let (ascii_digits : Wikifn_Primitive_Kernel.text) =
  ...
  (Prims.of_int (56));
  (Prims.of_int (57))]
let (latin_rot13_source : Wikifn_Primitive_Kernel.text) =
  [(Prims.of_int (65));
  (Prims.of_int (66));
  (Prims.of_int (67));
  (Prims.of_int (68));
  ...
  (Prims.of_int (121));
  (Prims.of_int (122))]
let (latin_rot13_target : Wikifn_Primitive_Kernel.text) =
  [(Prims.of_int (78));
  (Prims.of_int (79));
  (Prims.of_int (80));
  (Prims.of_int (81));
  ...
  (Prims.of_int (108));
  (Prims.of_int (109))]
let (superscript_source : Wikifn_Primitive_Kernel.text) =
  [(Prims.of_int (48));
  (Prims.of_int (49));
  (Prims.of_int (50));
  (Prims.of_int (51));
  ...
  (Prims.of_int (40));
  (Prims.of_int (41))]
let (superscript_target : Wikifn_Primitive_Kernel.text) =
  [(Prims.of_int (8304));
  (Prims.of_int (185));
  (Prims.of_int (178));
  (Prims.of_int (179));
  ...
  (Prims.of_int (8317));
  (Prims.of_int (8318))]
let (subscript_digits : Wikifn_Primitive_Kernel.text) =
  [(Prims.of_int (8320));
  (Prims.of_int (8321));
  (Prims.of_int (8322));
  (Prims.of_int (8323));
...
let (z11082_fallback_if_string_is_empty :
  ...
  fun value ->
    fun fallback ->
      if Wikifn_Primitive_Kernel.z10008_is_empty_string value
      then Wikifn_Primitive_Kernel.KOk fallback
      else Wikifn_Primitive_Kernel.KOk value
...
let (z10627_rot13_latin_alphabet :
  ...
  fun fuel ->
    fun input ->
      z14613_replace_character_set_fuel fuel input latin_rot13_source
        latin_rot13_target
let (z19612_turn_to_superscript :
  ...
  fun fuel ->
    fun input ->
      z14613_replace_character_set_fuel fuel input superscript_source
        superscript_target
let (z22649_arabic_numerals_to_devanagari_numerals :
  ...
  fun fuel ->
    fun input ->
      z14613_replace_character_set_fuel fuel input ascii_digits
        devanagari_digits
